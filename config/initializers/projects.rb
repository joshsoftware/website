PROJECTS= [
  ...
  { 
    ...
    country: "Canada",
    flag: "assets/portfolio/ca.gif",
    year: "2011",
    url: "http://www.thedealpages.com",
    image: "assets/portfolio/joshsoftware_deal-pages.jpg",
    description: "TheDealPages a one-stop directory for all the best daily deals in your city. You can browse hundreds of limited time offers to purchase great deals from local business for 40-90% off!",
    technical: {
  ...
  { 
    ...
    title: "ClearTrip",
    country: "India",
    flag: "assets/portfolio/in.gif",
    year: "2011",
    url: "http://hotel.cleartrip.com",
    image: "assets/portfolio/joshsoftware_clear-trip.jpg",
    ...
    technical: {
        stack: "Rails 3.0.7, MySQL, Memcached, nginx + passgenger",
...

  {
    ...
    title: "TourConnect",
    country: "Australia",
    flag: "assets/portfolio/au.gif",
    year: "2012",
    url: "http://tourconnect.com",
    image: "assets/portfolio/joshsoftware_tourconnect.jpg",
...

  {
    ...
    image: "assets/portfolio/joshsoftware_1factory.jpg",
...

  {
    ...
    image: "assets/portfolio/joshsoftware_groupgyaan.jpg",
...

  {
    ...
    title: "Move Planner",
    country: "UK",
    flag: "assets/portfolio/gb.gif",
    year: "2011",
    url: "http://planner.moveme.com",
    image: "assets/portfolio/joshsoftware_moveme.jpg",
...

  {
    ...
    image: "assets/portfolio/joshsoftware_ipalm.jpg",
