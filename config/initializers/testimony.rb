...
<p>    The Josh team takes great pride in their work, takes great care to ensure their clients' success, and we have grown to feel strongly that our Josh team is part of the family in our venture.  We would recommend Josh team for any server side development project and have already referred other entrepreneurs we know to engage them.</p> ",
  ...
  },
  {
    id: "conceivian",
    title: "CEO",
    url: "http://www.conceivian.com",
    company: "Conceivian",
    endorser: "Saqib Rasool",
    endorsement: "Gautam and his guys are a smart set of people. They helped us out at a critical time, when our company needed immediate growth. Enjoyed working with them.",
    display: true
  },
  {
    id: "the-deal-pages",
    ...
    company: "The Deal Pages",
    endorser: "Dave Kaiser",
    endorsement: "Josh Software is a great company and I highly recommend them. They are very professional, responsive and easy to work with. In addition, they are very responsive and reliable.",
    display: true
  },
  {
    id: "the-deal-pages-1",
  ...
  },
  {
    id: "group-gyaan",
    title: "Founder",
    url: "http://www.groupgyaan.com",
    company: "GroupGyaan.com",
    endorser: "Hetal Rach",
  ...
  },
  {
    ...
    url: "http://www.twentyci.co.uk",
    company: "Twenty Ci Limited",
    endorser: "Mark Godfrey",
  ...
  },
  {
    ...
    title: "Founder",
    url: "",
    company: "Paisamatters.com",
    endorser: "Anand Kulkarni",
