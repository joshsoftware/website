    ...
    <footer className="josh-footer">
      <div className="container">
        <div className="connect-wrap">
          <p>Connect with us</p>
          <div className="social-media-links"><a href="https://facebook.com/joshsoftware" target="_blank">
        ...
        <div className="footer-nav-wrap">
          ...
          <nav className="nav footer-nav"><a href="about-us.html" className="nav-link">Company</a>
            ...
            <a href="https://blog.joshsoftware.com/" target="_blank" className="nav-link">Blog</a>
        ...
        <div className="social-links-wrap">
          <div className="policy-wrap">
            <p className="text-policy">
              <a href="https://s3.ap-south-1.amazonaws.com/josh-website/PrivacyPolicyWebsite.pdf" target="_blank">
                View Privacy Policy
              </a>
            </p>
