    ...
    <footer className="josh-footer">
      <div className="container">
        <div className="connect-wrap">
          <p>Connect with us</p>
          <div className="social-media-links"><a href="https://facebook.com/joshsoftware" target="_blank" rel="noopener noreferrer">
        ...
        <div className="social-links-wrap">
          <div className="policy-wrap">
            <p className="text-policy">
              <a href="https://s3.ap-south-1.amazonaws.com/josh-website/PrivacyPolicyWebsite.pdf" target="_blank" rel="noopener noreferrer">
                View Privacy Policy
              </a>
            </p>
            <p className="text-copyright">Copyright © 2007 - 2019 Josh Software Pvt. Ltd.</p>
          </div>
        </div>
      </div>
    </footer>
