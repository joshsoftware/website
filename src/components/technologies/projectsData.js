export const ProjectData = [
  ...
  },
  {
    ...
    description:
      "This portal helps the doctors to shorten the consultation time as well as automate the process right from registering the patient till the prescription of drugs and referring the patient to other doctors if need be.",
  },
  // {
  //   title: "Zenith",
  //   flag: "au.gif",
  ...
  //   logo: "star.png",
  //   description:
  //     "A digital platform to streamline budgets for advertising inventory and media spends. An automated proposal creator that optimizes the availability of advertising slots based on channel, programs, show ratings and keeps tracks the data and revenue generated from these ads",
  //   techStack: ["Ruby", "Rails", "React", "PostgreSQL", "AWS", "GRPC", "Go "],
  // },
  // {
  //   title: "GoPay",
  //   url: "",
  ...
  //   logo: "gotix.png",
  //   description:
  //     "Gotix is an entertainment ticket selling service, GoTix is a movie & event discovery with on-demand ticket order services. We have designed both of it's B2C and B2B applications using React and ROR.",
  ...
  //   logo: "gomart.png",
  //   description:
  //     "Go-Mart is an instant shopping service to meet your everyday needs by Go-Jek Indonesia. We have re-architected & written the new backend of the GoMart, We were involved in tasks like database schema design, designing & implementing REST API’s as per mobile wireframes and CMS for the same.",
  //   techStack: [
  //     "Ruby v2.1.2",
  //     "Rails v4.2.5",
  //     "Postgres v9.4",
  ...
  //   logo: "gofood.png",
  //   description:
  //     "GoFood is food delivery app by Gojek used in Indonesia, Thailand, Vietnam. We have created services for creation and application of different types of discounts on customer's food bookings.",
  //   techStack: ["GO "],
  // },
  // {
  //   title: "GoShop",
  ...
  //   logo: "goshop.png",
  //   description:
  //     "With GoShop customer can order already known items from shops and also deliver packages from one location to another. We have re-architected & written the new OMS(order management system) of the GoShop app.",
  //   techStack: ["GO "],
  // },
  {
    title: "Bidwheelz",
    ...
    androidAppUrl:
      "https://play.google.com/store/apps/details?id=com.bidwheelz.app",
    iosAppUrl: "https://apps.apple.com/in/app/bidwheelz/id1400396083",
    logo: "bidwheelz.png",
    description:
      "Bidwheelz offers the best online platform to buy & sell your used cars without any headache. Bidwheelz would want to make sure that we are an equal participant in your happiness. With a large platform of car selling domain, Bidwheelz is here to stand out in the market by offering one of a kind Online Live Bidding.",
    techStack: [
      "Ruby 2.6.3",
      "Rails 6.0.1",
      "Redis",
  ...
  //   androidAppUrl: "https://play.google.com/store/apps/details?id=com.glluu",
  //   iosAppUrl: "https://apps.apple.com/in/app/glluu/id1462762714",
  //   logo: "glluu.png",
  //   description:
  ...
  //   techStack: ["Rails", "Postgres", "Android", "iOS"],
  // },
  // {
  //   title: "Flip",
  //   url: "https://play.google.com/store/apps/details?id=com.quirklabs.letsflipp&hl=en",
  //   androidAppUrl:
  //     "https://play.google.com/store/apps/details?id=com.quirklabs.letsflipp",
  //   iosAppUrl: "https://apps.apple.com/in/app/lets-flip/id1484600482",
  //   logo: "flip.png",
  //   description:
  //     "Flip is a peer to peer book sharing application for children. This involves 4 key steps. \n Upload books to your virtual bookshelf \n Search, View and request books from friends book shelf. Deliver the book to the friend (in the real world). On reading, book is returned to friend",
  //   techStack: ["Android", "iOS", "Rails", "Flutter"],
  // },
  // {
  //   title: "mVaahan",
  //   url: "https://play.google.com/store/apps/details?id=com.mvaahan",
  //   androidAppUrl: "https://play.google.com/store/apps/details?id=com.mvaahan",
  //   iosAppUrl: "",
  //   logo: "mvaahan.png",
  //   description:
  //     "The RTO mandates all commercial vehicles to apply reflective stickers around the body of the vehicle for clear identification of vehicle especially during the night. \n Given the breakdown rate on our unlit highways/expressways, that tiny piece of reflective tape could mean the difference between a catastrophic accident and an emergency stop/lane change manoeuvre! As these are critical for security, these stickers need to be of specific quality and always applied. However, vehicle owners try to put counterfeit (to save cost) or not at all. To prevent these the RTO uses mVaahan app to provide a compliance certificate by scanning the authentic QR code from the reflective stickers.",
  //   techStack: ["Rails", "Android"],
  // },
  // {
  //   title: "Medunbound",
  //   url: "https://play.google.com/store/apps/developer?id=Bizunbound+Analytics+Pvt.+Ltd.&hl=en",
  //   androidAppUrl:
  //     "https://play.google.com/store/apps/collection/cluster?clp=igNLChkKEzc2NDgzODUwOTA1MTU0MjcxNTEQCBgDEiwKJmNvbS5iaXp1bmJvdW5kLm1lZHVuYm91bmQuc2lvbnBoYXJtYWN5EAEYAxgB:S:ANO1ljJYpkU&gsr=Ck6KA0sKGQoTNzY0ODM4NTA5MDUxNTQyNzE1MRAIGAMSLAomY29tLmJpenVuYm91bmQubWVkdW5ib3VuZC5zaW9ucGhhcm1hY3kQARgDGAE%3D:S:ANO1ljL5tmM",
  //   iosAppUrl: "",
  //   logo: "biznunbound.png",
  //   description:
  //     "Medunbound provides medium to Small and Micro Entrepreneurs, single store or retail chains, to build their own branded Android and iOS MOBILE APPLICATION with  a STRONG ANALYTICAL system for a subscription fee. Now, store can focus on GROWING THEIR BUSINESS BEYOND BOUNDARIES.",
  //   techStack: [
  //     "Android",
  //     "Rails",
  //     "Ruby",
  ...
  // },
  {
    ...
    androidAppUrl:
      "https://play.google.com/store/apps/details?id=com.simplysmart.app",
    iosAppUrl:
      "https://apps.apple.com/in/app/simplysmart-solutions/id1102408572",
    logo: "simplysmart.png",
    description:
      "Gather data from multiple water and electricity meters and send it to the cloud server. Analysis for daily consumption and billing. Graphical comparison usage of water / electricity with other houses of the same type. Send notifications when thresholds are crossed.",
    techStack: ["Android", "iOS", "Rails", "ElasticSearch", "Redis"],
  },
  // {
  //   title: "Swalekhan",
  //   url: "https://play.google.com/store/apps/details?id=com.techvision.swalekhan&hl=en_IN",
  //   androidAppUrl:
  //     "https://play.google.com/store/apps/details?id=com.techvision.swalekhan",
  //   iosAppUrl: "",
  //   logo: "swalekhan.png",
  //   description:
  //     "We developed an Android App that is intended to have a social impact. The intention is to enable blind students be independent of scribes (writers) to write their exams. This application runs with mostly human voice guided assistance accompanied with Text-To-Speech guided assistance at few places.",
  //   techStack: ["Android", "Rails"],
  // },
  // {
  //   title: "BanyanOps",
  //   url: "https://banyanops.com/",
  //   androidAppUrl: "",
  //   iosAppUrl: "https://apps.apple.com/in/app/banyanops/id1453956263",
  //   logo: "banyan.png",
  //   description:
  ...
  //   techStack: ["Android", "iOS", "Go "],
  // },
  {
    title: "Freedom From Diabetes",
    url: "https://play.google.com/store/apps/details?id=com.ffd&hl=en_IN",
    androidAppUrl: "https://play.google.com/store/apps/details?id=com.ffd",
    iosAppUrl:
      "https://apps.apple.com/us/app/freedom-from-diabetes-app/id1187804668",
    logo: "ffd.png",
    description:
      "The Freedom from Diabetes App is a true companion on your journey of reversing diabetes! This App provides education, inspiration and support to diabetics across the world, through an easy, unique way by staying connected with an assigned team of doctors, dieticians, and mentors. Free users, receive daily messages related to diet, exercise, relevant activity, freedom story, etc. They can keep a record of their blood sugar levels and other vitals like BP and weight. They also   get to communicate with The Freedom Doctor for a limited period of time. Paid users, can communicate with an assigned doctor and send their blood sugar levels, diet and exercise details. They can also communicate with an assigned mentor to get help and moral support whenever needed.",
    techStack: ["Rails", "TrailBlazer", "Android", "iOS", "ElasticSearch"],
  },
  // {
  //   title: "Bebanx",
  //   url: "",
  ...
  //   logo: "gojek.png",
  //   description:
  //     "Protecting the privacy of customers has become essential in almost every business. It’s a precautionary step most businesses are willing to take. So we develop anonymization service in Golang, which can anonymize customer and driver original phone numbers to safeguard their identity, and prevent misuse of sensitive information during phone calls.",
  //   techStack: ["Go ", "Redis", "PostgreSQL", "NewRelic"],
  // },
];
