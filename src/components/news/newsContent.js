           ...
           news[year].map((n, i) => (
             <Col sm="4" lg="4" md="4" xs="12" className="d-flex align-items-stretch pb-8" key={i}>
               <Card body>
                 ...
                 <CardText className="module line-clamp">{n.description}</CardText>
                 <CardSubtitle>{n.formatted_date}</CardSubtitle>
                 <a href={n.link} target='_blank' rel="noopener noreferrer" style={{color: 'black'}} className="d-flex align-items-end">
                   <Button outline color="danger" size="sm" className="align-self-end"> Know More </Button>
                 </a>
               </Card>
             </Col>
           ))
