    ...
    <Fragment>
      ...
      <section className="josh-content">
        <div className="josh-leadership-wrapper d-flex align-items-center flex-column">
          <div className="leadership-col d-flex flex-wrap justify-content-center">
            <div className="leadership-content page-info">
            ...
            <div className="leadership-content founders-col">
              <div className="content-wrapper d-flex flex-column">
