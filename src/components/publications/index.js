...
import { S3_IMAGS_PATH, FACEBOOK_SHARE_URL, TWITTER_SHARE_URL, LINKED_IN_SHARE_URL } from '../../globalConstants.js';
  ...
  <Media query="(max-width: 500px)">
    {
      ...
      ? (
        <Row className="justify-content-center mt-5 pt-2">
          <Col>
            <h2 align="center" style={{color: 'black'}}><b>OUR PUBLICATIONS</b></h2>
          </Col>
        </Row>
        )
      : (
...
const shareCard = ({book}) => (
  <div className="book-share-card justify-content-center">
    ...
    <Row style={{color: '#ec6611'}}>
      ...
      <Col md='6' lg='6' sm='6' xs='6'>
        <svg id="i-book" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" width="32"
            height="30" fill="none" stroke="currentcolor" strokeLinecap="round"
